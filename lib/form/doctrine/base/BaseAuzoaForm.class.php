...
/**
 * Auzoa form base class.
 *
 * @method Auzoa getObject() Returns the current form's model object
 *
 * @package    gerkud
 * @subpackage form
 ...
 * @version    SVN: $Id$
 */
abstract class BaseAuzoaForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->validatorSchema->setPostValidator(
      new sfValidatorDoctrineUnique(array('model' => 'Auzoa', 'column' => array('izena')))
    );

    $this->widgetSchema->setNameFormat('auzoa[%s]');
