...
abstract class BaseGertakariaForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'hasiera_adieraz'    => new sfWidgetFormDate(),
      'amaiera_adieraz'    => new sfWidgetFormDate(),
    ...
    $this->setValidators(array(
      ...
      'hasiera_adieraz'    => new sfValidatorDate(array('required' => false)),
      'amaiera_adieraz'    => new sfValidatorDate(array('required' => false)),
