...
abstract class BaseGertakariaFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'herritarrena'        => new sfWidgetFormChoice(array('choices' => array('' => 'yes or no', 1 => 'yes', 0 => 'no'))),
    ...
    $this->setValidators(array(
      ...
      'herritarrena'        => new sfValidatorChoice(array('required' => false, 'choices' => array('', 1, 0))),
