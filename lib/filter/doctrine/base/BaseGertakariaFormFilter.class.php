...
abstract class BaseGertakariaFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'harremanetarako'    => new sfWidgetFormFilterInput(),
      ...
      'hasiera_adieraz'    => new sfWidgetFormFilterDate(array('from_date' => new sfWidgetFormDate(), 'to_date' => new sfWidgetFormDate())),
      'amaiera_adieraz'    => new sfWidgetFormFilterDate(array('from_date' => new sfWidgetFormDate(), 'to_date' => new sfWidgetFormDate())),
    ...
    $this->setValidators(array(
      ...
      'harremanetarako'    => new sfValidatorPass(array('required' => false)),
      ...
      'hasiera_adieraz'    => new sfValidatorDateRange(array('required' => false, 'from_date' => new sfValidatorDate(array('required' => false)), 'to_date' => new sfValidatorDateTime(array('required' => false)))),
      'amaiera_adieraz'    => new sfValidatorDateRange(array('required' => false, 'from_date' => new sfValidatorDate(array('required' => false)), 'to_date' => new sfValidatorDateTime(array('required' => false)))),
  ...
  public function getFields()
  {
    return array(
      ...
      'deskribapena'       => 'Text',
      'ixte_data'          => 'Date',
      'hasiera_adieraz'    => 'Date',
      'amaiera_adieraz'    => 'Date',
