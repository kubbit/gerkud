...
abstract class BasesfGuardUserFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'ohartaraztea_id'  => new sfWidgetFormFilterInput(),
    ...
    $this->setValidators(array(
      ...
      'ohartaraztea_id'  => new sfValidatorSchemaFilter('text', new sfValidatorInteger(array('required' => false))),
