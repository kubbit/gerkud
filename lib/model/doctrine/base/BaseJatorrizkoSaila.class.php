 ...
 * @method JatorrizkoSaila     setIzena()      Sets the current record's "izena" value
 * @method JatorrizkoSaila     setGertakaria() Sets the current record's "Gertakaria" collection
 * 
 * @package    gerkud
 * @subpackage model
