...
<?php if ($sf_user->hasCredential(array('admins', 'gerkud'), false)): ?>
		<div>
			...
			<?php echo __($form['hasiera_aurreikusia']->getError()); ?>
		</div>
		<div>
			<label><?php echo __('Amaiera aurreikusia') ?>:</label>
			<?php echo $form['amaiera_aurreikusia']->render(); ?>
			<?php echo __($form['amaiera_aurreikusia']->getError()); ?>
		</div>
<?php endif; ?>
		...
		<div>
			...
			<?php echo __($form['deskribapena']->getError()); ?>
		</div>
