...
<br><br><br>
  <table class="formularioa" style="width:60%">
    <thead>
        <tr><th class="ezker" colspan=3><h3>Nere datuak aldatu</h3></th>
    </thead>
    <tbody>
      <?php //echo $form ?>
<!--	<tr><th class="ezker" colspan=3>Nere datuak aldatu</th>  -->
	<tr><th class="eskuin"><br></th><td class="ezker"><br></td><th rowspan=5 class="panela">
          <a class="boton" href="<?php echo url_for('gertakaria/index') ?>">Itzuli gertakarien zerrendara</a><br><br>
          <input type="submit" value="Gorde" /><br>
	</th></tr>
		<?php //echo $form['username']->render(array('readonly'=>'readonly'));?>
        <tr><th class="eskuin">Erabiltzailea:</th><td class="ezker">
		<?php echo $form['username']->render(array('readonly'=>'readonly','size'=>30));  ?>
	</td></tr>
        <tr><th class="eskuin">Izena:</th><td class="ezker"><?php echo $form['first_name']->render(array('size'=>30)) ?></td></tr>
        <tr><th class="eskuin">Abizena(k):</th><td class="ezker"><?php echo $form['last_name']->render(array('size'=>30)) ?></td></tr>
        <tr><th class="eskuin">Posta elektronikoa:</th><td class="ezker"><?php echo $form['email_address']->render(array('size'=>30)) ?></td></tr>
        <tr><th class="eskuin">Ohartarazi:</th><td class="ezker"><?php echo $form['ohartaraztea_id']->render() ?></td></tr>
        <tr><th colspan=3><br>
