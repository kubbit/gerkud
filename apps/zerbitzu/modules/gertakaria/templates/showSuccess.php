...
<table width=80% class="gertakaria">
  ...
  <tbody>
	...
	<?php if (($gertakaria->getEgoeraId()!=5)&&($gertakaria->getEgoeraId()!=6)): ?>
                        ...
                        <?php $form2->setDefault ('langilea_id', $sf_user->getGuardUser()->getId()); ?>
                        ...
                        <div id="izkutua"  style="display:none">
                                <?php echo $form2['gertakaria_id']->render();  ?>
                                <?php echo $form2['ekintza_id']->render();  ?>
                                <?php echo $form2['langilea_id']->render();  ?>

                                <?php if ($form2->isCSRFProtected()) : ?>
                                  <?php echo $form2['_csrf_token']->render(); ?>
                                <?php endif; ?>
                        </div>
        	<?php if (($gertakaria->getSaila()=='')||($sf_user->hasGroup($temp['name']))): ?>
	...
	<?php if (($gertakaria->getEgoeraId()!=5)&&($gertakaria->getEgoeraId()!=6)): ?>
	<!--Erabiltzailearen sailari esleitutako gertakaria bada, prozesuan jarri, itxi edo baztertu dezake -->
		<?php //$temp=$gertakaria->getSaila(); ?>
	        <?php if (($gertakaria->getSaila()!='')&&($sf_user->hasGroup($temp['name']))): ?>
			<br>
	...
	<?php if (($gertakaria->getEgoeraId()==5)||($gertakaria->getEgoeraId()==6)): ?>
        	<?php $form3 = new IruzkinaForm(); ?>
                ...
                <?php $form3->setDefault ('langilea_id', $sf_user->getGuardUser()->getId()); ?>
...
<!--
    <tr>
      ...
      <td colspan=3 class="azkena"><pre><?php //echo $gertakaria->getDeskribapena(); ?></pre></td>
-->
...
<!--   <tr><td class="ezker" colspan=4><b>Historikoa<b></td></tr> -->
<!--   <tr><td class="ezker">Data</td><td class="ezker">Nork</td><td class="ezker">Ekintza</td><td class="ezker">Iruzkina</td></tr>-->
